    ...
    return(
      ...
      <div className="p-8">
        <div className="flex justify-center">
          <h1 className="text-3xl font-semibold underline">Suzuki Alto 2024 Price in Pakistan,Images,Reviews & Specs</h1>
        </div>

        <div className="flex justify-center mt-10">
          <div className="w-1/6"><img src="alto1.jpg" alt="corolla details" /></div>
        </div>
        ...
        <ul className="flex space-x-5 text-sm justify-center py-4">
          ...
          <li className="text-black dark:text-white font-semibold">Engine <span className="text-slate-500">660 CC</span></li>
          <li className="text-black dark:text-white font-semibold">Condition <span className="text-slate-500">9.5 / 10</span></li>
          <li className="text-black dark:text-white font-semibold">Driven <span className="text-slate-500">4,500 KM</span></li>
          ...
          <li className="text-black dark:text-white font-semibold">Avg <span className="text-slate-500">22 Km pr ltr</span></li>
