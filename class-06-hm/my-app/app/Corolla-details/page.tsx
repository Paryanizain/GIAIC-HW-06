    ...
    return(
      ...
      <div className="p-8">
        ...
        <div className="flex justify-center mt-10">
          <div className="w-1/6"><img src="corolla1.jpg" alt="corolla details" /></div>
        </div>
        ...
        <ul className="flex space-x-5 text-sm justify-center py-4">
          ...
          <li className="text-black dark:text-white font-semibold">Engine <span className="text-slate-500">1800 CC</span></li>
          <li className="text-black dark:text-white font-semibold">Condition <span className="text-slate-500">8.5 / 10</span></li>
          <li className="text-black dark:text-white font-semibold">Driven <span className="text-slate-500">9,500 KM</span></li>
          ...
          <li className="text-black dark:text-white font-semibold">Avg <span className="text-slate-500">13 Km pr ltr</span></li>
