  ...
  return (
    <div>
      ...
      <div className="bg-slate-100 py-8 px-10 dark:bg-slate-700">
        ...
        <Link href="/Corolla-details"><li className=" hover:opacity-50 transition duration-300"><img src="/Corolla-X-Cars.jpg" alt="Toyota Corolla" /></li></Link>
        ...
        <ul className="w-1/4 bg-white">
        <Link href="/City-details"><li className=" hover:opacity-50 transition duration-300"><img src="/Honda_City.jpg" alt="Honda City" /></li></Link>
        ...
        <ul className="w-1/4 bg-white">
        <Link href="/Juke-details"><li className=" hover:opacity-50 transition duration-300"><img src="/Nissan_Juke01.png" alt="Nissan Juke" /></li></Link>
        ...
        <ul className="w-1/4 bg-white">
        <Link href="/Alto-details"><li className=" hover:opacity-50 transition duration-300"><img src="/Suzuki_Alto_2015.jpg" alt="Suzuki Alto" /></li></Link>
